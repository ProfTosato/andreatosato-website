...
[Claude, throughout reconsider and where possible find ways to not use emdashes]
Stablecoins are digital assets issued on public blockchain networks that are designed to maintain a stable price relative to a reference asset, most commonly the United States dollar [Claude we need to add that they can also be pegged to other fiat currencies or precious metal].[^1] Unlike volatile cryptocurrencies such as Bitcoin and Ether, whose prices are driven primarily by supply and demand and market sentiment, stablecoins combine the technological advantages of distributed ledger technology — disintermediation, cryptographic security, programmability — with the price stability of traditional currencies.[^2] From approximately $1 billion in circulation in 2019, total stablecoin supply now exceeds $250 [Claude, the number is now higher i think as of May 2026] billion and is projected to reach $4 trillion by 2030, with major payment providers including PayPal and Western Union actively incorporating stablecoins into their product portfolios and leading financial institutions such as Fidelity exploring stablecoin issuance.[^3]

Stablecoins serve multiple functions within the financial system. Their original and still predominant use is as a base currency for trading other digital assets. Over time, they have also become the preferred settlement medium in decentralized finance protocols, facilitate billions of dollars in cross-border payments annually, and are increasingly used as an inflation hedge in economies where domestic payment systems lack trust and coverage [Claude, shorten a little the inflation hedge description and add that they are also starting to be used for retail transactions, albeit on a small scale].[^4] This growing economic significance has prompted regulatory responses on both sides of the Atlantic, culminating in the European Union's Markets in Crypto-Assets Regulation (MiCAR) and the United States' GENIUS Act, enacted in July 2025.[^5]

Understanding the legal architecture of stablecoins is essential for practitioners, lawmakers, researchers, and students navigating this rapidly evolving landscape. The analysis that follows addresses the questions most frequently asked about these instruments. Throughout, the reader should bear in mind a distinction that runs through every question: the analysis often diverges significantly depending on whether one is considering a centralized stablecoin, issued by an identifiable company such as Tether, Circle or PayPal, or a decentralized stablecoin, controlled by an autonomous software protocol such as MakerDAO. Most readers will be primarily interested in centralized stablecoins, which dominate the market, but the decentralized variants raise distinct legal challenges that are noted where relevant.
...
For decentralized stablecoins such as DAI, the stabilization mechanism is different. Users deposit volatile digital assets (such as Ether) into non-custodial vaults controlled by the protocol's smart contracts and can generate DAI up to a predetermined percentage of the value of those locked assets.[^22] The specific ratios vary by asset type and are established through governance; for example, a user depositing $1,000 worth of Ether might be able to generate up to $750 worth of DAI. Because the value of the locked assets always exceeds the value of DAI generated, the system maintains a surplus that serves as a buffer against price volatility. If the market value of deposited assets declines below a safety threshold, the protocol automatically seizes and auctions them, with the proceeds burned to reduce the DAI supply and maintain the peg.[^23] No issuer stands behind this process; it is purely algorithmic. [Claude, add a sentence here saying that despite  wording such as collateral, collaterazlied position and similar being used it is important to point out that there are no seucred transactions being created, there is no lending, security interest or foreclosure in the legal sense. In fact the imprecise usage of these words is a lamentable and a source of confusion. Again we make this point clearly in the Regulating Decentralized stablecoins essay. So read it and reference it]

[claude, this paragraph about fees should be right after the discussion of reserve backed stabilization] An important practical consideration is that transaction fees can undermine the stabilization mechanism. Tether, for example, charges a 0.1% fee for minting and the greater of $1,000 or 0.1% for redemption, with $100,000 minimum thresholds.[^24] Arbitrageurs will only act to correct price deviations to the extent the spread exceeds total fees, meaning that a 0.2% total fee creates a floor below which the arbitrage mechanism does not operate.[^25]
[claude, this section needs to be expanded, we need a paragraph explaning dual coin stabilization and how it has failed historically. The article The PRivate law of stablecoins has an ample discussion you can draw from. Cite it. We also need a section for purely algorithmic stabilization such as that of Ampleforth. Again covered in the PRivate law of stablecoins]

## Are Stablecoins Money?

[Considering the purpose of this page, i think that we should open with a paragraph giving the simple answer that stablecoins are not money in the sense that they are not legal tender. But that "money" is a much broader concept than just legal tender. Modern economies rely on a multiplicity of instruments that function as money (intended as medium of exchange, store of value, unit of account) that are not legal tender such as bank deposits, Electronic money (e-money) — the balance held in a digital wallet with a provider such as PayPal or Cash App and money market funds. Then transition to what we have below adjusting accordingly to avoid repetitions. Inform yourself with the introduction and Part I of The moneyness of stablecoins where we cover this in detail. Overall, I believe that the answer to this question can be much better. Starting from the simple answer and then going into the substance of our Moneyness paper, the concept of moneyness and offering the conclusion that we reach in the paper that currently stablecoins do not have a high degree of moneyness. Make also sure that this answer jells well with the other answers below]
...
[Claude, I have read this is actually fine]
...
[Claude, I don't like the "at the intersection of two of Professor Tosato's major contributions "  we shold remove it throughout - we don't need to use these formulations when this article is found on my personal website and cites all my articles. Let's just answer the questions]
...
**Two constructions under the GENIUS Act.** The Genius Act defines a payment stablecoin as a digital asset whose issuer "is obligated to convert, redeem, or repurchase for a fixed amount of monetary value," but does not resolve whether this obligation is embedded in the token or remains separate.[^58] Two possible constructions exist:
...
The stakes of this interpretive choice are considerable. The former approach enables true negotiability and allows the token to function as a complete monetary instrument carrying its value-realization mechanism within itself. The latter introduces complexity and uncertainty into every stablecoin transaction.[^61] [Claude, here we should add something to the effect that the first construction is preferable - but not certain]

[Claude the content of this paragraph should go before the segment "Two constructions under the GENIUS Act" in the "**The redemption right as a separate asset.**" segment] **Pre-GENIUS Act: the two-tiered system.** Before the GENIUS Act, the private law framework was even more restrictive. Tether limited direct contractual relationships to only 882 verified customer accounts worldwide; Circle to 1,834 Circle Mint accounts.[^62] Secondary market holders — the vast majority — existed in a legal vacuum vis-à-vis the issuer, possessing stablecoin tokens as personal property under Article 12 but maintaining no contractual privity and consequently no direct redemption claim.[^63]

**For decentralized stablecoins**, the analysis collapses entirely. There is no issuer, no contractual relationship, no redemption right, and no entity against which any claim could be asserted. Users interact exclusively with autonomous code [claude, this needs to be expanded to say that therefore anything functionally similar to redemption is not a right, rather it is a technical feature of the system that users are using - but elegant concise wording].[^64]
